...
# docker build -t comments_notifications_app .
# docker run -d -p 80:80 -e RAILS_MASTER_KEY=<value from config/master.key> --name comments_notifications_app comments_notifications_app
